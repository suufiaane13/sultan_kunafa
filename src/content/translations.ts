...
const translations = {
  fr: {
    ...
    products: {
      ...
      tartelette: {
        name: "Tartelette",
        description: "Tartelette gourmande aux fruits.",
        descriptionShort: "Tartelette",
      },
      tiramisu: {
        name: "Tiramisu",
        description: "Plusieurs goûts au choix.",
        descriptionShort: "Goûts variés",
        flavors: {
          classique: "Classique",
          oreo: "Oreo",
          raffaello: "Raffaello",
  ...
  ar: {
    ...
    products: {
      ...
      tiramisu: {
        name: "تيراميسو",
        description: "عدة أذواق للاختيار.",
        descriptionShort: "أذواق متعددة",
        flavors: {
          classique: "كلاسيك",
          oreo: "أوريو",
          raffaello: "رافايلو",
